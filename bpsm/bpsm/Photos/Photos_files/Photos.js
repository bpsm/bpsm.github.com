...
{return IWCreateMediaCollection("http://bpsm.github.com/bpsm/bpsm/Photos/Photos_files/rss.xml",true,255,["No photos yet","%d photo","%d photos"],["","%d clip","%d clips"]);}
function initializeMediaStream_id2()
{createMediaStream_id2().load('http://bpsm.github.com/bpsm/bpsm/Photos',function(imageStream)
